<div class="border-top-tasks">
    <div class="bg-light rounded p-0 d-flex align-items-center justify-content-between mb-0 shadow-list dmk-tasks h-35px task-list task-on-subtask " data-task="{{ $task->id }}">
        ...
        <div class="d-flex align-items-center h-100 d-none d-md-flex">
            ...
            <div class="position-relative opacity-1">
                <input type="text"
                    class="form-control border-0 form-control-sm flatpickr w-auto bg-light text-center w-200px task-date task-date-{{ $task->id }}
